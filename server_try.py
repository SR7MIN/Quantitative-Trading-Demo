...
DATABSE_URI = 'mysql+mysqlconnector://{user}:{password}@{server}/{database}'.format(
    user='root', password='123456', server='localhost', database='db_fin_tech')
...
# 插入数据
student1 = Users(account='1257047642', name="", password="123456")
# student2 = Users(account="1271060910",name='Bob',password="123")
# session.add_all([student1, student2])
# session.commit()

# # 查询数据
# students = session.query(Users).all()
