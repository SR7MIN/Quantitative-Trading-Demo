<template>
      ...
      <div class="demo-drawer__content">
        <el-form :model="form">
          ...
          <el-form-item label="股票所属市场" :label-width="formLabelWidth">
            <el-select
              v-model="form.place"
              placeholder="Please select stock area"
            >
  ...
  <div>
    ...
    <el-table :data="stock_history" stripe style="width: 100%" height="500">
...
async function get_stock_history() {
  // 获取历史交易记录
