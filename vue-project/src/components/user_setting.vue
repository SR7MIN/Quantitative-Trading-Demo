          ...
          <el-row>
            <el-col :span="12">
              ...
              <el-card style="max-width: 480px; margin-bottom: 20px">
                ...
                <el-form ref="formRef" label-width="auto">
                  ...
                  <el-form-item label="账号" prop="zone">{{
                    user.account
                  }}</el-form-item>
            ...
            <el-col :span="12">
              ...
              <el-card style="max-width: 480px">
                ...
                <el-row> 您的账号安全等级：<br /> </el-row>
                <div class="demo-progress">
                  <el-progress
                    :text-inside="true"
                    :stroke-width="26"
                    :percentage="passwordSecurityLevel"
              ...
              <el-form ref="formRef" label-width="auto">
                ...
                <el-form-item>
                  ...
                  >
                    ...
                    <template #footer>
                      <div class="dialog-footer">
                        <el-button @click="rechargeDialog = false"
                          >取消</el-button
                        >
...
const rules = reactive({
  ...
  old: [{ validator: validate_old, trigger: 'blur' }],
  confirm: [{ validator: validate_confirm, trigger: 'blur' }],
  // 其他字段的验证规则
})
function validatePassword(rule, value, callback) {
  //不知道为啥只有这个验证规则还不能正常运行
    ...
    .then(async ({ value }) => {
      try {
        ...
        const res = await axios.post(
          'http://localhost:5000/home/change-nickname',
          {
...
const bind_email = () => {
  // 没和数据库交互，所以只能空填写，没作用，后续或可加入邮箱密码找回功能
...
const submitPasswordChange = async () => {
  ...
  try {
    ...
    if (res.data.status === 'success') {
      ...
      passwordSecurityLevel.value = getPasswordSecurityLevel(
        user.value.password
      )
    } else {
      ElMessage({
